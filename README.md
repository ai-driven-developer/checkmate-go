...
internal/
  ...
  search/              PVS, quiescence, TT, move ordering, SEE, killer moves, countermove heuristic, history heuristic, LMR, null-move pruning, IIR, reverse futility pruning, futility pruning, late move pruning, delta pruning, improving heuristic, check extensions, aspiration windows, time control, Lazy SMP

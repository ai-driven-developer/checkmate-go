...
internal/
  ...
  search/              PVS, quiescence, TT, move ordering, SEE, killer moves, history heuristic, LMR, null-move pruning, IIR, reverse futility pruning, futility pruning, late move pruning, check extensions, aspiration windows, time control, Lazy SMP
